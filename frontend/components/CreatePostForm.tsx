            ...
            <form onSubmit={handleSubmit}>
                ...
                {imagePreview && (
                    <div className="_mar_t16 _mar_b16">
                        <img src={imagePreview} alt="Preview" style={{ maxWidth: '100%', borderRadius: '6px' }} />
                        <button
                            type="button"
                        ...
                        <div className="_feed_inner_text_area_bottom_video _feed_common">
                            <div className="dropdown">
                                ...
                                >
                                    {privacy === 'public' ? (
                                        <>
                                            <span className="_mar_r4">🌍</span> Public
                                        </>
                                    ) : (
                                        <>
                                            <span className="_mar_r4">🔒</span> Private
                                        </>
                                    )}
                                </button>
                                <ul className="dropdown-menu" aria-labelledby="privacyDropdown">
                                    <li>
                                        <button className="dropdown-item" type="button" onClick={() => setPrivacy('public')}>
                                            🌍 Public
                                        </button>
                                    </li>
                                    <li>
                                        <button className="dropdown-item" type="button" onClick={() => setPrivacy('private')}>
                                            🔒 Private
                                        </button>
                                    </li>
                                </ul>
