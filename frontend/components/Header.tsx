...
export default function Header() {
    ...
    const toggleNotifyDropdown = () => setShowNotifyDropdown(!showNotifyDropdown);
                ...
                <div className="container _custom_container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
                            ...
                            <li className="nav-item _header_nav_item">
                                <Link className="nav-link _header_nav_link" aria-current="page" href="#0">
                            ...
                            <li className="nav-item _header_nav_item">
                                <span id="_notify_btn" className="nav-link _header_nav_link _header_notify_btn" onClick={toggleNotifyDropdown} style={{ cursor: 'pointer' }}>
                            ...
                            <div id="_prfoile_drop" className={`_nav_profile_dropdown _profile_dropdown ${showProfileDropdown ? 'show' : ''}`}>
                                <div className="_nav_profile_dropdown_info">
                                    ...
                                    <div className="_nav_profile_dropdown_info_txt">
                                        <h4 className="_nav_dropdown_title">{user ? `${user.firstName || ''} ${user.lastName || ''}`.trim() || user.email : 'Guest'}</h4>
                                ...
                                <ul className="_nav_dropdown_list">
                                    ...
                                    <li className="_nav_dropdown_list_item">
                                        <button onClick={logout} className="_nav_dropdown_link" style={{ width: '100%', border: 'none', background: 'none', textAlign: 'left', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <div className="_nav_drop_info">
                                                <span>
